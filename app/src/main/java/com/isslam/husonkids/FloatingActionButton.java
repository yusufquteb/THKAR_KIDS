  ...
  */
  ...
  void updateBackground() {
    ...
    LayerDrawable layerDrawable = new LayerDrawable(
        new Drawable[] {
            androidx.core.content.ContextCompat.getDrawable(getContext(), mSize == SIZE_NORMAL ? R.drawable.fab_bg_normal : R.drawable.fab_bg_mini),
  ...
  Drawable getIconDrawable() {
    if (mIconDrawable != null) {
      ...
      return androidx.core.content.ContextCompat.getDrawable(getContext(), mIcon);
    } else {
